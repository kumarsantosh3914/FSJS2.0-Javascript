...
// Slice
let names = ['Hitesh Sir', 'Anurag', 'Surya', 'santosh', 'Bipul'];
...
let num1 = [1, 2, 3, 'santosh', 4, 5, 6, 7, 8, 'Anurag', 'Anurag'];
console.log(num1.indexOf('Anurag'));

// isArray()
let num2 = [1, 2, 3, 'Anurag', 4, 5, 6, 7, 8, 'Anurag', 'Anurag'];
let num3 = 'Anurag';
