...
function fetchData(url) {
    return new Promise(function (resolve, reject) {
        ...
        setTimeout(function processDownloading() {
            ...
            resolve(data);
            // console.log("Hello");
            resolve("Santosh"); // these lines will not be executed as promise is fulfilled only once
        }, 70000);
    });
}
...
// the above will not work in required fashion
...
//     });
// });
// the above piece of code solves inversion of control, but still gets promise hell
